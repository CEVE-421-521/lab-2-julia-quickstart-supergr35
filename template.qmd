...
author: "Grant Parajuli (gap6)" # YOU SHOULD EDIT THIS
date: 2024-01-19
week: 2
categories: [Lab]
...
```{julia}
df[!, :day] = Dates.dayofyear.(df.datetime)

dropmissing!(df, :lsl)

df_byday = groupby(df, :day)
...
# There is a lot of daily variability which is smoothed over in the monthly data.
```